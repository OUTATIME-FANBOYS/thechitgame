        ...
        {!game ? (
          ...
          <div className="space-y-3">
            <Card className="text-center">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Game created!</p>
              <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400 tracking-widest">{game.roomCode}</p>
            </Card>
